    ...
    if (spotifyApi.getAccessToken()) {
      ...
      spotifyApi.getMe().then(function (userData) {
        ...
        offsetArr.forEach((item) => {
          spotifyApi
            .getUserPlaylists({ offset: item, limit: 50 })
            .then((data) => {
              // Get playlists where playlists.owner.id === session.user.username
              const userPlaylists = data.body.items.filter(
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="overlay__description">
            ...
            personal sonic experiences for a few friends. Today, it represents a
            deep dive into the sub-communities that drive user-to-user activity
